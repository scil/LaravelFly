...
class SuperGlobalVarsTest extends BaseTestCase
{
...
//
//        /**
//         * grep not support nested directories
...
//       $cmd = 'cd '. static::$root .' && find . -path ./node_modules -prune -o  -path ./storage -prune -o  -path ./vendor/filp/whoops -prune -o  -path ./vendor/eaglewu/swoole-ide-helper -prune -o  -path ./vendor/maximebf/debugbar -prune -o  -path ./vendor/phpunit/phpunit -prune -o  -path ./vendor/predis/predis/examples  -prune -o  -path ./vendor/scil/laravel-fly -prune -o  -path ./vendor/sebastian/global-state -prune -o  -path  ./vendor/symfony/http-foundation/Tests  -prune -o -path ./vendor/symfony/http-foundation  -prune -o -path ./vendor/monolog/monolog -prune -o  -type f -exec grep -E "\b_(GET|POST|FILES|COOKIE|SESSION|REQUEST)\b" --exclude=*.md --exclude=_ide_helper.php   -l  {} \; ';
//
//        ob_start();
//        passthru($cmd);
//        $output = ob_get_clean();
...
F;
        self::assertEquals($respect, $output);
         ...
         $cmd = 'cd '. static::$root .' && find . -path ./node_modules -prune -o  -path ./storage -prune -o  -path  ./vendor/phpunit/phpunit -prune -o  -path  ./vendor/scil/laravel-fly -prune -o   -path  ./vendor/symfony/http-foundation/Tests  -prune  -o  -type f -exec grep -E "\bcreateFromGlobals\b" --exclude=*.md --exclude=_ide_helper.php   -H -n {} \;  ';
